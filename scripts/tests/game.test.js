...
describe("game object contains correct keys", () => {
    ...
    test("does lastButton exist in game object", () => {
        expect("lastButton" in game).toBe(true);
    });
    test("does turnInProgress exist in game object", () => {
...
describe("gameplay works correctly", () => {
    ...
    test("should call an alert if move is wrong", () => {
        ...
        playerTurn();
        expect(window.alert).toBeCalledWith("wrong move fool!");
    });
    test("turnInProgess key is set to true", () => {
        showTurns();
